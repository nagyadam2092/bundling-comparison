var liQ = (function () {
	...
	var TrackerConfig_1 = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(TrackerConfig_1);

	var rollupTypescript = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });


	var trackerConfig = new TrackerConfig_1.default();
	trackerConfig.setCookieName('new-cookie-name');
	document.write(lodash.snakeCase(trackerConfig.getCookieName()));

	});

	var index = unwrapExports(rollupTypescript);
